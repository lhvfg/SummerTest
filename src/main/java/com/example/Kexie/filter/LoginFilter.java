...
//            //在白名单中的url,放行访问
//            if (url.startsWith("/static") || url.equals("/index") || url.startsWith("/login") || url.startsWith("/clearSession") || url.startsWith("/register")|| url.startsWith("/changePassword")) {
...
//                    httpResponse.sendRedirect("/api/index");
//                } else {
